  ...
  return (
    <div className="clientes-wrapper">
      ...
      <div className="clientes-header">
        <h2 className="clientes-header-title">Gestión de Clientes</h2>
        <p className="clientes-header-description">
          Visualice y administre todos los clientes registrados en su sistema. Cada cliente está vinculado a una conversación 
          de chat, pertenece a su empresa y puede tener asignado un estado para clasificar su situación actual 
          (Nuevo, Activo, Inactivo, etc.).
        </p>
      </div>
              ...
              <table className="clientes-table">
                <thead className="clientes-table-header">
                  <tr className="grid grid-cols-11">
                    ...
                    <th className="clientes-table-header-cell col-span-3">Email</th>
                ...
                <tbody>
                  {currentClientes.map((cliente, index) => (
                    <tr key={cliente.id} className="clientes-table-row grid grid-cols-11">
                      ...
                      <td className="clientes-table-cell clientes-table-cell-email col-span-3">
                        {cliente.email ? (
                      ...
                      <td className="clientes-table-cell col-span-1">
                        {cliente.tipo_doc ? (
                      ...
                      <td className="clientes-table-cell clientes-table-cell-center col-span-1">
                        <span className="clientes-fecha">
                          {formatShortDate(cliente.createdAt.toString())}
                        </span>
                      </td>
                    </tr>
                  ))}
